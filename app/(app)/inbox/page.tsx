      ...
      >
        <div className="grid grid-cols-[1fr_360px] gap-16">
          ...
          <aside className="space-y-14">
            ...
            {/* Footer (Z:371–376) — honest until the Notifier ships */}
            <section className="pt-4 border-t border-stone-200/80">
              <p className="text-sm italic text-stone-500 leading-relaxed">
                This page is the durable record of what happened. Email summaries arrive
                in a later release — nothing depends on your real inbox yet.
              </p>
            </section>
          </aside>
        </div>
